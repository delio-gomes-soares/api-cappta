 ...
 */
final class Version20180722200332 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD CONSTRAINT FK_723705D1924526F1 FOREIGN KEY (acquirer_id) REFERENCES acquirer (id)');
    }
